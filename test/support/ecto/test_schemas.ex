...
defmodule Test.Ecto.TestSchemas do
  ...
  # Binary ID schemas with associations
  defmodule BinaryIdOrganizationSchema do
    use Ecto.Schema

    @primary_key {:id, :binary_id, autogenerate: true}
    @foreign_key_type :binary_id
    schema "binary_id_organizations" do
      field(:name, :string)
      has_many(:users, BinaryIdUserSchema)
    end
  end

  defmodule BinaryIdUserSchema do
    use Ecto.Schema
    ...
    schema "binary_id_users" do
      field(:name, :string)
      field(:email, :string)
      belongs_to(:organization, BinaryIdOrganizationSchema)
      has_many(:posts, BinaryIdPostSchema)
    end
  end

  defmodule BinaryIdPostSchema do
    use Ecto.Schema

    @primary_key {:id, :binary_id, autogenerate: true}
    @foreign_key_type :binary_id
    schema "binary_id_posts" do
      field(:title, :string)
      field(:content, :string)
      belongs_to(:user, BinaryIdUserSchema)
    end
  end
end
