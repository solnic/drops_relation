defmodule Ecto.Relation.MetadataIntegrationTest do
  use Ecto.RelationCase, async: false

  alias Ecto.Relation.SQL.Inference, as: SQLInference
  ...
  describe "metadata integration with field inference" do
    ...
    test "inferred fields include metadata from database introspection" do
      schema = SQLInference.infer_from_table("metadata_test", Ecto.Relation.Repos.Sqlite)
    ...
    test "custom fields merge with inferred metadata" do
      ...
      ecto_relation_schema = SQLInference.infer_from_table("metadata_test", Ecto.Relation.Repos.Sqlite)
  ...
  describe "Field.merge behavior in practice" do
    ...
    test "custom field options override inferred metadata appropriately" do
      ...
      custom_field =
        Ecto.Relation.Schema.Field.new(
          :status,
          :string,
      ...
      # Merge them
      merged = Ecto.Relation.Schema.Field.merge(status_field, custom_field)
