defmodule Ecto.Relation.SQL.Introspector.Database.PostgresTest do
  @moduledoc """
  ...
  alias Ecto.Relation.SQL.Introspector.Database.Postgres
  ...
  describe "full inference behavior" do
    ...
    test "infers correct Ecto types from postgres_types test table", %{repo: repo} do
      ...
      assert %Ecto.Relation.Schema.PrimaryKey{} = schema.primary_key
      ...
      assert %Ecto.Relation.Schema.Indices{} = schema.indices
