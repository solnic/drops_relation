defmodule Ecto.Relation.Schema.MetadataExtractor do
  @moduledoc """
  ...
  ## Usage
      ...
      metadata = Ecto.Relation.Schema.MetadataExtractor.extract_metadata(
        MyApp.User,
        MyApp.Repo
      )

      # Extract specific metadata types
      primary_key = Ecto.Relation.Schema.MetadataExtractor.extract_primary_key(MyApp.User)
      foreign_keys = Ecto.Relation.Schema.MetadataExtractor.extract_foreign_keys(MyApp.User)
  """
  ...
  ## Examples
      ...
      iex> metadata = Ecto.Relation.Schema.MetadataExtractor.extract_metadata(MyApp.User, MyApp.Repo)
      iex> metadata.primary_key
      %Ecto.Relation.Schema.PrimaryKey{fields: [:id]}
  """
  ...
  ## Examples
      ...
      iex> Ecto.Relation.Schema.MetadataExtractor.extract_primary_key(MyApp.User)
      %Ecto.Relation.Schema.PrimaryKey{fields: [:id]}
  """
  ...
  ## Examples
      ...
      iex> Ecto.Relation.Schema.MetadataExtractor.extract_foreign_keys(MyApp.Post)
      [%Ecto.Relation.Schema.ForeignKey{field: :user_id, ...}]
  """
  ...
  ## Examples
      ...
      iex> fields = Ecto.Relation.Schema.MetadataExtractor.extract_fields(MyApp.User)
      iex> Enum.find(fields, & &1.name == :email)
      %Ecto.Relation.Schema.Field{name: :email, type: :string, ecto_type: :string, source: :email}
  """
  ...
  ## Examples
      ...
      iex> Ecto.Relation.Schema.MetadataExtractor.extract_indices(MyApp.User, MyApp.Repo)
  ...
  ## Examples
      ...
      iex> foreign_keys = Ecto.Relation.Schema.MetadataExtractor.extract_foreign_keys(MyApp.Post)
      iex> Ecto.Relation.Schema.MetadataExtractor.foreign_key?(foreign_keys, :user_id)
      true
  """
  ...
  ## Examples
      ...
      iex> foreign_keys = Ecto.Relation.Schema.MetadataExtractor.extract_foreign_keys(MyApp.Post)
      iex> Ecto.Relation.Schema.MetadataExtractor.find_foreign_key(foreign_keys, :user_id)
      %Ecto.Relation.Schema.ForeignKey{field: :user_id, ...}
  """
  ...
  ## Examples
      ...
      iex> associations = Ecto.Relation.Schema.MetadataExtractor.extract_associations(MyApp.Post)
