defmodule Ecto.Relation.Schema.Field do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Ecto.Relation.Schema.Field.new(:email, :string, :string, :email)
      %Ecto.Relation.Schema.Field{
        name: :email,
        type: :string,
        ecto_type: :string,
      ...
      iex> Ecto.Relation.Schema.Field.new(:status, :string, :string, :status, meta)
      %Ecto.Relation.Schema.Field{
        name: :status,
        type: :string,
        ecto_type: :string,
  ...
  ## Examples
      ...
      iex> Ecto.Relation.Schema.Field.from_metadata(metadata)
      %Ecto.Relation.Schema.Field{
        name: :email,
        type: :string,
        ecto_type: :string,
  ...
  defimpl Inspect do
    def inspect(%Ecto.Relation.Schema.Field{} = field, _opts) do
  ...
  ## Examples
      ...
      iex> Ecto.Relation.Schema.Field.to_metadata(field)
  ...
  ## Examples
      ...
      iex> inferred = Ecto.Relation.Schema.Field.new(:email, :string, :string, :email, %{nullable: true})
      iex> custom = Ecto.Relation.Schema.Field.new(:email, :string, {:parameterized, {Ecto.Enum, %{values: [:active, :inactive]}}}, :email)
      iex> merged = Ecto.Relation.Schema.Field.merge(inferred, custom)
  ...
  ## Examples
      ...
      iex> field1 = Ecto.Relation.Schema.Field.new(:email, :string, :string, :email)
      iex> field2 = Ecto.Relation.Schema.Field.new(:email, :text, :text, :email_address)
      iex> Ecto.Relation.Schema.Field.same_name?(field1, field2)
      true
  """
  ...
  ## Examples
      ...
      iex> field = Ecto.Relation.Schema.Field.new(:email, :string, :string, :email)
      iex> Ecto.Relation.Schema.Field.matches_name?(field, :email)
      true

      iex> Ecto.Relation.Schema.Field.matches_name?(field, :name)
      false
  """
...
defimpl Ecto.Relation.Inference.SchemaFieldAST, for: Ecto.Relation.Schema.Field do
  @moduledoc """
  ...
  parameterized types.
  """
  def to_field_ast(%Ecto.Relation.Schema.Field{} = field) do
  ...
  """
  def to_field_ast_with_category(%Ecto.Relation.Schema.Field{} = field, category) do
  ...
  """
  def to_attribute_ast(%Ecto.Relation.Schema.Field{} = field) do
