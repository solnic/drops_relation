defmodule Ecto.Relation.Schema.Generator do
  @moduledoc """
  ...
  def generate_schema_module(table_name, module_name, options) do
    ...
    ecto_relation_schema = SQL.Inference.infer_from_table(table_name, repo)

    generate_module_content(module_name, table_name, ecto_relation_schema)
  end

  @doc """
  Generates the module content from a Ecto.Relation.Schema struct.

  ## Parameters

  - `module_name` - The full module name
  - `table_name` - The database table name
  - `schema` - The Ecto.Relation.Schema struct with metadata
  ...
  - `table_name` - The database table name
  - `schema` - The Ecto.Relation.Schema struct with new metadata
