defmodule Ecto.Relation.Query do
  ...
  @doc false
  def generate_functions(opts, ecto_relation_schema) do
    repo = opts[:repo]
    ...
    index_functions = generate_index_based_finders(repo, ecto_relation_schema)
  ...
  defp generate_index_based_finders(repo, ecto_relation_schema) do
    if Indices.empty?(ecto_relation_schema.indices) do
      []
    else
      indices = ecto_relation_schema.indices.indices
