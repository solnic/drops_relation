defmodule Ecto.Relation.Composite do
  @moduledoc """
  ...
  ## Examples
      ...
      composite = Ecto.Relation.Composite.new(
        users_relation,
        posts_relation,
        :posts,
        MyApp.Repo
  ...
  ## Examples
      ...
      association = Ecto.Relation.Composite.infer_association(Users, Posts)
      # => :posts
  """
...
defimpl Ecto.Queryable, for: Ecto.Relation.Composite do
  import Ecto.Query
...
defimpl Enumerable, for: Ecto.Relation.Composite do
