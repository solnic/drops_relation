defprotocol Drops.Relation.Inference.SchemaFieldAST do
  @moduledoc """
  ...
  The protocol is automatically implemented for `Drops.Relation.Schema.Field` structs
  ...
  ## Examples
      ...
      defimpl Drops.Relation.Inference.SchemaFieldAST, for: MyApp.CustomField do
