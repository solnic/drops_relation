defmodule Drops.Relation.SQL.Database.ForeignKey do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Drops.Relation.SQL.Database.ForeignKey.new(
      ...>   "fk_posts_user_id",
      ...>   ["user_id"],
      ...>   "users",
      ...>   ["id"],
  ...
  ## Examples
      ...
      iex> Drops.Relation.SQL.Database.ForeignKey.simple("user_id", "users")
      %Drops.Relation.SQL.Database.ForeignKey{
        name: nil,
        columns: ["user_id"],
        referenced_table: "users",
      ...
      iex> Drops.Relation.SQL.Database.ForeignKey.simple("organization_id", "organizations", "uuid")
      %Drops.Relation.SQL.Database.ForeignKey{
        name: nil,
  ...
  ## Examples
      ...
      iex> fk = Drops.Relation.SQL.Database.ForeignKey.simple("user_id", "users")
      iex> Drops.Relation.SQL.Database.ForeignKey.composite?(fk)
      false

      iex> fk = Drops.Relation.SQL.Database.ForeignKey.new(
      ...>   nil,
      ...>   ["user_id", "role_id"],
      ...>   "user_roles",
      ...>   ["user_id", "role_id"]
  ...
  ## Examples
      ...
      ...>   ["user_id", "role_id"]
      ...> )
      iex> Drops.Relation.SQL.Database.ForeignKey.column_names(fk)
      ["user_id", "role_id"]
  """
  ...
  ## Examples
      ...
      iex> fk = Drops.Relation.SQL.Database.ForeignKey.simple("user_id", "users")
      iex> Drops.Relation.SQL.Database.ForeignKey.referenced_column_names(fk)
      ["id"]
  """
  ...
  ## Examples
      ...
      ...>   ["user_id", "role_id"]
      ...> )
      iex> Drops.Relation.SQL.Database.ForeignKey.includes_column?(fk, "user_id")
      true

      iex> fk = Drops.Relation.SQL.Database.ForeignKey.simple("user_id", "users")
      iex> Drops.Relation.SQL.Database.ForeignKey.includes_column?(fk, "role_id")
      false
  """
  ...
  ## Examples
      ...
      iex> fk = Drops.Relation.SQL.Database.ForeignKey.simple("user_id", "users")
      iex> Drops.Relation.SQL.Database.ForeignKey.column_count(fk)
      1
...
defimpl Drops.Relation.Schema.Field.Inference, for: Drops.Relation.SQL.Database.ForeignKey do
  @moduledoc """
  ...
  def to_schema_field(%Drops.Relation.SQL.Database.ForeignKey{} = foreign_key, _table) do
    field_name =
