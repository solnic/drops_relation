defmodule Ecto.Relation.Repos.Postgres.Migrations.CreateBinaryIdTables do
  use Ecto.Migration
  ...
  def change do
    ...
    create table(:binary_id_users, primary_key: false) do
      ...
      add :name, :string
      add :email, :string
      add :organization_id, references(:binary_id_organizations, type: :binary_id, on_delete: :delete_all)
