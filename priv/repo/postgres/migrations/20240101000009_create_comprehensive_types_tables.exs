defmodule Ecto.Relation.Repos.Postgres.Migrations.CreateComprehensiveTypesTables do
  use Ecto.Migration
  ...
  def change do
    ...
    create table(:postgres_types) do
      ...
      add :inet_type, :string         # Will map to string for now
      add :cidr_type, :string         # Will map to string for now
      add :macaddr_type, :string      # Will map to string for now
    ...
    create table(:postgres_serial_aliases) do
      add :serial4_id, :serial      # serial4 alias
      add :serial8_id, :bigserial   # serial8 alias
      add :serial2_id, :smallserial # serial2 alias
      add :regular_serial, :serial  # regular serial for comparison
      add :regular_bigserial, :bigserial # regular bigserial for comparison
      add :regular_smallserial, :smallserial # regular smallserial for comparison
    end
